...
### Your Task:
1.  Analyze the user's request based on the main topic and the conversation history. If the history is empty, provide a warm welcome and a concise, engaging introduction to the main topic.
