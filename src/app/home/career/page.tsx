      ...
      <div className="flex flex-col gap-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-medium">{cv.fileName || 'uploaded_document.docx'}</span>
          </div>
        ...
        <div className="border rounded-md p-6 bg-muted/30 text-center">
          ...
          <p className="text-sm text-muted-foreground mb-4">
            Word document uploaded. AI can analyze the content but preview is not available in browser.
          </p>
          <Button variant="outline" size="sm" asChild>
            <a href={cv.dataUri} download={cv.fileName}>
              Download Document
            </a>
          </Button>
        </div>
