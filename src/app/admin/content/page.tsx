...
By using our application, Prepezia, you agree to be bound by these Terms of Use. If you do not agree to these Terms, do not use the application.
...
## 5. Use of API Keys
If you choose to use your personal Gemini API Key, you are responsible for its security and usage. Prepezia is not responsible for any charges or issues arising from the use of your personal API key. The key is stored locally on your device and not on our servers.

## 6. Monetization and Ads
The Service is supported by advertising revenue and may display advertisements and promotions from Google AdSense. Some features may require you to watch a rewarded advertisement. The manner, mode, and extent of advertising by Prepezia on the Service are subject to change without specific notice to you.
...
In no event shall Prepezia, nor its directors, employees, partners, agents, suppliers, or affiliates, be liable for any indirect, incidental, special, consequential or punitive damages, including without limitation, loss of profits, data, use, goodwill, or other intangible losses, resulting from your access to or use of or inability to access or use the Service.
...
Email: [support@prepezia.com](mailto:support@prepezia.com)
Website: [www.prepezia.com](https://www.prepezia.com)
`;

const initialPrivacyContent = `## 1. Introduction
Welcome to Prepezia ("we," "our," or "us"). We are committed to protecting your privacy and handling your personal data in an open and transparent manner. This privacy policy explains how we collect, use, disclose, and safeguard your information when you use our application.
